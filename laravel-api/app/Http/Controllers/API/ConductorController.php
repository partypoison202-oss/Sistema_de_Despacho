...
class ConductorController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'accidentes_siniestros' => 'sometimes|nullable|integer|min:0',
            'faltas' => 'sometimes|nullable|integer|min:0',
            'retardos' => 'sometimes|nullable|integer|min:0',
            'amonestaciones' => 'sometimes|nullable|integer|min:0',
            'reconocimientos' => 'sometimes|nullable|integer|min:0',
            'condicionamientos_medicos' => 'sometimes|nullable|string|max:255',
            'condicionamientos_juridicos' => 'sometimes|nullable|string|max:255',
            'permutas' => 'sometimes|nullable|integer|min:0',
            'permisos' => 'sometimes|nullable|integer|min:0',
