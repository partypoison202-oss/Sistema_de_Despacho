...
export default function DetalleUnidadEncierro() {
  ...
  const getConductorDisplay = () => {
    ...
    if (relevoName && String(relevoName).trim() !== '') {
      ...
      const titularStr = (cleanTitularName && cleanTitularName !== cleanRelevoName && cleanTitularName !== 'Sin conductor' && cleanTitularName !== 'No reportado hoy') ? cleanTitularName : (val && val !== cleanRelevoName ? val : '');
      return (
    ...
    try {
      ...
      if (resultado.status === 'success') {
        setDatosOperativos({
          ...
          relevo_conductor: resultado.relevo_conductor || '',
          relevo_tarjeton: resultado.relevo_tarjeton || '',
          relevo_hora: resultado.relevo_hora || '',
        });
