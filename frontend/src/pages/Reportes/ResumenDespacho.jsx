            ...
            <table className="resumen-table">
              <thead>
                <tr>
                  ...
                  <th style={{ width: '13%' }}>Unidades<br/>Programadas</th>
                  <th style={{ width: '13%' }}>En Operación</th>
                  <th style={{ width: '13%' }}>Porcentaje<br/>Eficiencia</th>
                  <th className="gold-bg" style={{ width: '13%' }}>Unidades en<br/>Mantenimiento</th>
                  <th className="gold-bg" style={{ width: '35%' }}>Tipo de Falla</th>
                </tr>
              </thead>
              <tbody>
                {modelData.map((row) => (
